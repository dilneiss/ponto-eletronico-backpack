                    ...
                    <div>
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control" name="senha_atual" autocomplete="current-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="new_password" type="password" class="form-control" name="nova_senha" autocomplete="current-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="confirmacao_senha" type="password" class="form-control" name="confirmacao_senha" autocomplete="current-password">
                                </div>
                            </div>
